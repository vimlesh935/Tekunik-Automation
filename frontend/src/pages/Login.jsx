              ...
              <form onSubmit={handleLogin}>
                <Appear delay={320} style={{ marginBottom: 16 }}>
                  <AuthInput
                    ...
                    icon={<svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M22 4 12 13 2 4"/></svg>}
                    autoComplete="email"
                  />
                </Appear>
