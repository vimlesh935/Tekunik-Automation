    ...
    <svg viewBox="0 0 440 600" style={{ width: "100%", height: "100%", position: "absolute", inset: 0 }} aria-hidden="true">
      ...
      {edges.map(([a, b], i) => (
        <line key={i} x1={nodes[a].cx} y1={nodes[a].cy} x2={nodes[b].cx} y2={nodes[b].cy}
          stroke="url(#edgeGrad2)" strokeWidth="1"
...
const Icons = {
  ...
  state: <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>,
              ...
              <form onSubmit={handleRegister}>
                ...
                <Appear delay={540} style={{ marginBottom: 16 }}>
                  <AuthInput label="State" value={form.state}
                    ...
                    placeholder="Maharashtra" icon={Icons.state} disabled={stateLocked} />
                </Appear>
                ...
                {pincodeError && (
                  <Appear delay={0} style={{ marginTop: error ? 8 : 16, marginBottom: 8 }}>
                    <div style={{
                      display: "flex", alignItems: "flex-start", gap: 10,
                      padding: "10px 14px", background: "rgba(248,113,113,0.08)",
                      border: "1px solid rgba(248,113,113,0.2)", borderRadius: 12,
                      fontFamily: "'DM Mono', monospace", fontSize: 11, color: DANGER, lineHeight: 1.4,
                    }}>
                ...
                {pincodeLoading && (
                  <Appear delay={0} style={{ marginBottom: 8 }}>
                    <div style={{
                      display: "flex", alignItems: "center", gap: 8,
                      padding: "10px 14px", background: "rgba(124,58,237,0.06)",
                      border: "1px solid rgba(124,58,237,0.15)", borderRadius: 12,
                      fontFamily: "'DM Mono', monospace", fontSize: 11, color: VL, lineHeight: 1.4,
                    }}>
                      <span style={{
                        width: 14, height: 14, border: "2px solid rgba(124,58,237,0.3)",
