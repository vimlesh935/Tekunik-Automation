                ...
                return (
                  <div key={product.id} className="rounded-3xl border border-gray-800 bg-gray-900/70 p-5 transition hover:border-cyan-500/40 hover:shadow-2xl hover:shadow-cyan-500/10">
                    <div className="space-y-4">
                      <div className="rounded-3xl overflow-hidden bg-gray-800 relative">
                        {product.image_url ? (
                          <SafeImage
                        ...
                        <div className="rounded-2xl bg-white/5 p-4 text-sm text-gray-300">
                          ...
                          {hasDiscount(product) ? (
                            <div className="mt-1 flex items-center gap-2">
                              ...
                              <span className="text-xs text-gray-400 line-through">{formatCurrency(discountInfo.original_price)}</span>
                            </div>
                          ) : (
                            <span className="block mt-2 text-cyan-300 text-lg font-semibold">{formatCurrency(discountInfo.original_price)}</span>
                          )}
                        </div>
                        <div className="rounded-2xl bg-white/5 p-4 text-sm text-gray-300">
