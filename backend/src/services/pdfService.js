    ...
    try {
      ...
      const metaLine = (label, value, color = LIGHT) => {
        doc
          ...
          .font("Helvetica")
          .fillColor(MUTED)
          .text(label, 0, mY, { width: metaRight - 110, align: "right" });
        doc
          .fontSize(8)
          .font("Helvetica-Bold")
          .fillColor(color)
          .text(value, 0, mY, { width: metaRight, align: "right" });
        mY += 14;
      };
      ...
      if (order.tracking_number)
        metaLine("Tracking #", order.tracking_number, AMBER);
      ...
      doc
        ...
        .font("Helvetica-Bold")
        .fillColor(CYAN)
        .text("FROM", fx, cardY + 14);
      doc
        .fontSize(10)
        .font("Helvetica-Bold")
        .fillColor(NAVY)
        .text("Tek Node Technologies", fx, cardY + 26);
      doc
        .fontSize(8)
        .font("Helvetica")
        .fillColor(SLATE)
      ...
      doc
        ...
        .font("Helvetica-Bold")
        .fillColor(CYAN)
        .text("BILL TO", bx, cardY + 14);
      doc
        .fontSize(10)
        .font("Helvetica-Bold")
        .fillColor(NAVY)
        .text(customerName, bx, cardY + 26, { width: bw });

      let bY = cardY + 42;
      doc.fontSize(8).font("Helvetica").fillColor(SLATE);
      if (deliveryAddress) {
        doc.text(deliveryAddress, bx, bY, { width: bw });
        bY += 14;
      }
      if (cityLine) {
        doc.text(cityLine, bx, bY, { width: bw });
        bY += 14;
      }
      if (customerEmail) {
        doc.text(customerEmail, bx, bY, { width: bw });
        bY += 14;
      }
      if (customerPhone) {
        doc.text(customerPhone, bx, bY, { width: bw });
      }
      ...
      const pColor =
        pStatus === "paid" ? GREEN : pStatus === "failed" ? RED : AMBER;
      ...
      doc
        ...
        .font("Helvetica")
        .fillColor(MUTED)
        .text("PAYMENT METHOD", L + 12, pBarY + 7);
      doc
        .fontSize(9)
        .font("Helvetica-Bold")
        .fillColor(WHITE)
        .text(pMethod, L + 12, pBarY + 17);

      // center divider
      doc
        .moveTo(L + CW / 2, pBarY + 6)
        .lineTo(L + CW / 2, pBarY + 24)
        .strokeColor(SLATE)
        .lineWidth(1)
        .stroke();
      ...
      doc
        ...
        .font("Helvetica")
        .fillColor(MUTED)
        .text("PAYMENT STATUS", L + CW / 2 + 12, pBarY + 7);
      doc
        .fontSize(9)
        .font("Helvetica-Bold")
        .fillColor(pColor)
        .text(pStatus.toUpperCase(), L + CW / 2 + 12, pBarY + 17);
      ...
      for (const item of items) {
        ...
        doc.text(item.product_name || "Product", col.name.x, ty, {
          width: col.name.w,
        });
      ...
      // divider inside card
      doc
        .moveTo(totCardX + 10, tRow)
        .lineTo(totCardX + totCardW - 10, tRow)
        .strokeColor(LIGHT)
        .lineWidth(0.8)
        .stroke();
      tRow += 8;
      ...
      doc
        ...
        .font("Helvetica-Bold")
        .fillColor(CYAN)
        .text(fmt(totalVal), totCardX + 10, tRow - 2, {
          width: totCardW - 20,
          align: "right",
        });
      ...
      doc
        ...
        .font("Helvetica-Bold")
        .fillColor(NAVY)
        .text("Thank you for your order!", noteX + 12, noteY + 14, {
          width: noteW - 24,
        });
      doc
        .fontSize(8)
      ...
      doc
        ...
        .fillColor(MUTED)
        .text(
          "Tek Node Technologies  |  vimleshnew29@gmail.com  |  +91 00000 00000",
          0,
          footerY + 10,
